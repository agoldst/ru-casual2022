...
(For simple further exploration, I also created a tab-separated values file [downloadable from Github](https://github.com/agoldst/ru-casual2022/staffing2020.tsv) with these staffing category breakdowns for each Title IV university. The format is suitable for a spreadsheet program.)
